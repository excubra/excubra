    ...
    <CommandDialog open={open} onOpenChange={onOpenChange} title="Suche" description="Kunden, Standorte, Geräte, Boxen">
      ...
      <CommandList>
        ...
        <CommandGroup heading="Seiten">
          {[["/", "Übersicht"], ["/tenants", "Kunden"], ["/events", "Ereignisse"], ["/findings", "Prävention"], ["/boxes", "Boxen"], ["/updates", "Updates"], ["/maintenance", "Wartung"], ["/keys", "Enrollment-Keys"], ["/webhooks", "Webhooks"], ["/tokens", "API-Tokens"], ["/users", "Benutzer"], ["/audit", "Audit-Log"], ["/settings", "Einstellungen"]].map(([to, label]) => (
