...
scp -q image/provision-box.sh image/netbird-operator-netns.sh image/netbird-operator-netns.service image/netbird-operator.service image/netbird-operator-ssh.service image/excubra-agent-unit.sh image/excubra-agent-unit.path image/excubra-agent-unit.service deploy/systemd/excubra-agent.service "$TARGET:$R/"
echo "== provisioning"
